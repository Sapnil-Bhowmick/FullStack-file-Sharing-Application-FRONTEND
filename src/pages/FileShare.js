...
function FileShare() {
  ...
  const uploadFolder = React.useRef()
  ...
  const handleSingleFileUpload = (selectFolder) => {
    if (selectFolder) {
  ...
  const handleSingleImg = (e) => {
    ...
    // console.log('Files' , uploadedFilelist)
            ...
            <div ref={divRef}>
              ...
              <div className='single-text'> Drag and Drop file Here or
                <span
                  ...
                  onClick={() => handleSingleFileUpload(false)}
                > Choose File</span> or 

                <span
                  className='single-filelink'
                  onClick={() => handleSingleFileUpload(true)}
                > Choose Folder</span>
              </div>
            </div>
          </div>
